...
import com.vaibhav.repository.PasswordResetTokenRepository;
...
//		List<User> users= userRepository.findAllUserByUserIds(userIds);
	...
	public void sendPasswordResetEmail(User user) {
		...
		sendEmail(user.getEmail(), "Password Reset", "Click the following link to reset your password: https://frontend-three-kappa-18.vercel.app/reset-password?token=" + resetToken);
